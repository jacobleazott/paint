/**
 * This file is responsible for creating and storing our settings for our paint program which include
 * Color theme
 * Autosave Timer Enable
 * Autosave Timer Length
 *
...
public class PaintSettingsWindow {
    ...
    // Getters
    Stage getStage(){ return settings_window; }

    String[] get_color(){ return color_theme; }

    String getCSS(){ return settings_scene.getStylesheets().get(0); }

    // Displays our setting window
    void show(){ settings_window.show(); }

    // Updates the theme color of our setting window
    void update_color() {
